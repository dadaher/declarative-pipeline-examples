        ...
        stage('Tag Release') {
            ...
            steps {
                script {
                    ...
                    sh 'git branch -l'
                    sh 'git fetch'
                    sh 'git tag -a ex-v1.2.0 -m "ex Release v1.1.0"'
                    // Push the tag to the remote repository
                    sh 'git push origin ex-v1.2.0'
                    githubNotify description: 'This is a shorted example',  status: 'SUCCESS', repo: 'dadaher/declarative-pipeline-examples', credentialsId: 'New_Daher_token_full_2024', account: 'daher@dtp.ae', sha: env.COMMIT_ID
