            ...
            steps {
                script {
                   ...
                   // sh 'git push origin ex-v1.3.0'
                    githubNotify description: 'This is a shorted example',  status: 'SUCCESS', repo: 'declarative-pipeline-examples', credentialsId: 'New_Daher_token_full_2024', account: 'dadaher', sha: env.GIT_COMMIT
